...
client = Cloudant.iam('4094f476-a33a-4c3f-ac04-711517fe2195-bluemix','aJTkV8HEFHJbFzJMth3XcA-jovpyqvlZz2lc20OaHv0m', connect=True)
...
@app.route('/html log out')
def logout():
    return render_template('html log out.html')

@app.route('/redirects tml')
def predictions():
    return render_template('redirects tml.html')
...
def res():
    ...
    yolo.close_session()
    return render_template('rediction.html')
